    ...
    <div class="container d-flex flex-column justify-content-between">
        ...
        <section id="HiringSection1">
            <div class="parentHiring d-flex justify-content-between flex-column">
                <form oninput="upload()" id="hiringForm" class="d-flex justify-content-between flex-wrap
                flex-lg-row" action="{{ route('api.hiring.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                    <fieldset class="d-flex" style="position: relative;">
                        <legend>
                            Full name
                        </legend>
                        <input class="d-flex justify-content-end px-4"  type="text" name="name" id="name">
                    </fieldset>
                    <fieldset class="d-flex justify-content-end" style="position: relative;">
                        <legend id='userName'>
                            Your job title
                        </legend>
                        <input class="d-flex justify-content-end px-4" type="text" name="job_title" id="job_title">
                    </fieldset>
                    <fieldset class="jobOffer d-fle justify-content-end" style="position: relative;">
                        <legend id='userName'>
                            E-mail
                        </legend>
                        <input class="d-flex justify-content-end px-4" type="email" name="email" id="email">
                    </fieldset>
                    ...
                    <input id='file' name="file" type="file" class='result active d-flex flex-column justify-content-center align-items-center' value=""/>
                    <div class='result result1 d-flex flex-row justify-content-around align-items-center' type="submit">
                        <span class="uploading mb-0">Uploading ...</span>
                        <p class="loader mb-0"></p>
                    </div>
                    <div class='result result2 d-flex flex-row justify-content-between align-items-center' type="submit">
                        <span class="uploaded  d-flex align-items-center justify-content-center mb-0">
                            <img class="mx-1" src="{{ asset('front/images/Vector.jpg') }}" width="15" height="15" alt="">
                            Uploaded
                        </span>
                ...
                <div class="btn d-flex justify-content-end align-items-center px-0">
                    <button onclick="hiringSubmit()" type="submit" class="hiringBtn d-flex justify-content-center align-items-center py-2">Submit</button>
                </div>
